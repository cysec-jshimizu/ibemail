...
namespace IBEMail{
  ...
  struct IBEParams : public BB2::KGCParams{
    ...
    IBEParams(const mcl::bn256::G1 G, const mcl::bn256::G1 X, const mcl::bn256::G1 Y, mcl::bn256::Fp12 v) : BB2::KGCParams(G, X, Y, v){};
  ...
  struct IBEMasterKey : public BB2::KGCMasterKey{
    ...
    IBEMasterKey(const mcl::bn256::Fr x, const mcl::bn256::Fr y, const mcl::bn256::G2 H) : BB2::KGCMasterKey(x, y, H){};
  ...
  struct IBEUserKey : public BB2::UserKey{
    ...
    IBEUserKey(const mcl::bn256::Fr r, const mcl::bn256::G2 K) : BB2::UserKey(r, K){};
  ...
  struct IBECipher : public BB2::Cipher{
    ...
    IBECipher(const std::vector<unsigned char> a, const mcl::bn256::G1 B, const mcl::bn256::G1 C) : BB2::Cipher(a, B, C){};
  ...
  void G1ToBytes(std::vector<unsigned char> &bytes, const mcl::bn256::G1 &g1);
  void G2ToBytes(std::vector<unsigned char> &bytes, const mcl::bn256::G2 &g2);
  void Fp12ToBytes(std::vector<unsigned char> &bytes, const mcl::bn256::Fp12 &fp12);

  void G1FromBytes(mcl::bn256::G1 &g1, const std::vector<unsigned char> &bytes);
  void G2FromBytes(mcl::bn256::G2 &g2, const std::vector<unsigned char> &bytes);
  void Fp12FromBytes(mcl::bn256::Fp12 &fp12, const std::vector<unsigned char> &bytes);

  void G1EncodeBase64(std::string &enc, const mcl::bn256::G1 &g1);
  void G2EncodeBase64(std::string &enc, const mcl::bn256::G2 &g2);
  void Fp12EncodeBase64(std::string &enc, const mcl::bn256::Fp12 &fp12);

  void G1DecodeBase64(mcl::bn256::G1 &g1, const std::string &enc);
  void G2DecodeBase64(mcl::bn256::G2 &g2, const std::string &enc);
  void Fp12DecodeBase64(mcl::bn256::Fp12 &fp12, const std::string &enc);
}
